...
const siteUrl = process.env.SITE_URL || 'https://kyron.vercel.app';
const supportHandle = process.env.SUPPORT_HANDLE || '@KYRONSupport';
const channelHandle = process.env.CHANNEL_HANDLE || '@KYRON';
...
bot.launch();
console.log('KYRON bot is running');
